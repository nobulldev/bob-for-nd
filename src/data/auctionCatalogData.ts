...
export const AUCTION_CATALOG_DATA: AuctionCatalogRecord[] = [
  ...
  { id: "electric-fireplace", title: "Electric Fireplace", description: "Add instant warmth and atmosphere to your home without the work of a traditional fireplace.", type: "Live", valueAmount: 200, openingBid: 75, reserveAmount: null, sortOrder: 4 },
  ...
  { id: "outdoor-pizza-oven", title: "Outdoor/Wood-Fired Pizza Oven NWTF", description: "Bring wood-fired flavor outdoors with a pizza oven made for crisp crusts and memorable backyard meals.", type: "Live", valueAmount: 200, openingBid: 75, reserveAmount: null, sortOrder: 8 },
  { id: "jump-starter", title: "Cen-Tech Portable Jump Starter", description: "Be ready for a dead battery at home or on the road. This portable 750-peak-amp jump starter also includes a work light and 12V and USB power options.", type: "Silent", valueAmount: null, openingBid: 40, reserveAmount: 50, sortOrder: 9 },
  { id: "bottle-jack", title: "Pittsburgh 20-Ton Hydraulic Bottle Jack", description: "Heavy-duty lifting power for vehicles, trailers, equipment, and demanding workshop jobs.", type: "Silent", valueAmount: null, openingBid: 40, reserveAmount: 50, sortOrder: 10 },
  { id: "tongue-wrench", title: "Pittsburgh Torque Wrench", description: "A dependable addition to any toolbox for automotive maintenance, equipment repairs, and projects requiring precise tightening.", type: "Silent", valueAmount: null, openingBid: 20, reserveAmount: 30, sortOrder: 11 },
  { id: "locking-pliers", title: "Pittsburgh Curved Locking Pliers Set", description: "A practical locking-pliers set that provides a secure grip for repairs, maintenance, and workshop projects.", type: "Silent", valueAmount: null, openingBid: 10, reserveAmount: 20, sortOrder: 12 },
  { id: "screwdriver-set", title: "Pittsburgh Screwdriver Set", description: "A versatile set of everyday screwdrivers for household projects, repairs, workshop tasks, and regular maintenance.", type: "Silent", valueAmount: null, openingBid: 25, reserveAmount: 30, sortOrder: 13 },
  { id: "solar-cow", title: "Solar Cow", description: "Add personality to your garden with this charming reading Highland cow and colorful solar-powered flower light.", type: "Silent", valueAmount: null, openingBid: 15, reserveAmount: 25, sortOrder: 14 },
  { id: "metal-dog", title: "Decorative Metal Dog", description: "A playful metal dog with plenty of personality, ready to bring character and humor to your home, porch, or garden.", type: "Silent", valueAmount: null, openingBid: 15, reserveAmount: 25, sortOrder: 15 },
  { id: "birdhouse-wind-chime", title: "Decorative Birdhouse Wind Chime", description: "A cheerful birdhouse topped with a colorful bird and finished with a hanging bell to brighten any porch, patio, or garden.", type: "Silent", valueAmount: null, openingBid: 5, reserveAmount: 10, sortOrder: 16 },
